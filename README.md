...
| Name | Role |
|------|------|
| **Yankai Zheng** | Lead Developer: System Architecture, AI Agent, Data Analysis, Docker, ML/DL |
| **Minqiao Sun** | Pipeline Engineering, Charts Development, Documentation |
| **Yuxuan Hu** | Platform Design, Visualization Consulting |
